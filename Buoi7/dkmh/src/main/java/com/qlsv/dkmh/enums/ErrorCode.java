...
public enum ErrorCode {
    ...
    PHIEU_DANGKY_NOT_FOUND(1015, "Không tìm thấy phiếu đăng ký để xóa"),
    LOP_EXISTED_IN_DRAFT(1016, "Lớp đã có trong danh sách chọn"),
    SCHEDULE_CONFLICT_WITH_LOP(1017, "Xung đột thời khóa biểu với lớp"),
    LOP_NOT_FOUND_IN_DRAFT(1018, "Lớp không có trong danh sách chọn"),
    DRAFT_EMPTY(1019, "Không có lớp nào trong draft để nộp"),
    INVALID_MIN_CREDITS(1020, "Số tín chỉ đăng ký phải tối thiểu 10 tín chỉ"),
    INVALID_MAX_CREDITS(1021, "Số tín chỉ đăng ký không được vượt quá 15 tín chỉ"),;
